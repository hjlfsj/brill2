...
| canvas4 | 500×500 | 三维视图，束流方向 + 靶点到 D2 hit 空间射线 |
...
3. **TPolyLine3D 束流方向**：红色虚线，从靶点沿 PPAC 重建的束流方向 (dir_x, dir_y) 延伸到 z=140 平面
4. **TPolyMarker3D D2 hit**：绿色圆点，位于各 D2 hit 的 (x, y, z) 位置
5. **TPolyLine3D 射线**：从靶点到每个 D2 hit 的虚线，射线终点外推到 z=140 平面，每条射线用不同颜色
