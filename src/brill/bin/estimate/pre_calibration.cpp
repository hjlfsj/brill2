...
int main(int argc, char **argv) {
	...
	TH2F d1d2_pid("d1d2", "D1-D2 PID", 5000, 0.0, 65535.0, 5000, 0.0, 65535.0);
TH2F d2d3_pid("d2d3", "D2-D3 PID", 5000, 0.0, 65535.0, 5000, 0.0, 65535.0);
TH2F d3d4_pid("d3d4", "D3-D4 PID", 5000, 0.0, 65535.0, 5000, 0.0, 65535.0);
TH2F d4s_pid("d4s", "D4-S PID", 5000, 0.0, 65535.0, 5000, 0.0, 65535.0);
