...
const std::vector<ParticlePidInfo> pid_info {
	{0, 2,  4,  2250.0, 12000.0,   	   0},  // d1d2 4He
	{0, 3,  6,  4355.0, 12000.0,   13000},  // d1d2 6Li

	{1, 2,  4,  3890.0,  8250.0,   26000},  // d2d3 4He
	{1, 4,  7, 10930.0, 17320.0,   36000},  // d2d3 7Be
	{1, 6, 12, 22050.0, 45800.0,   55000},  // d2d3 12C

	{2, 2,  4,  3400.0,  7100.0,  102000},  // d3d4 4He
	{2, 4,  7,  9600.0, 18200.0,  110000},  // d3d4 7Be
	{2, 6, 12, 22050.0, 45800.0,  130000},  // d3d4 12C

	{3, 1,  1,  960.0,  2300.0,   180000},  // d4s  1H
	{3, 2,  4,  3890.0, 9430.0,   184000},  // d4s  4He
	{3, 3,  6,  7550.0, 16600.0,  200000},  // d4s  6Li
};
